...
import { userIdentityVerify } from "../../atom";
...
const SignUpMain = () => {
  ...
  const setUserID = useSetRecoilState(userIdentityVerify);
  const { registerType } = useSelector((state) => state.misc);
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="relative -top-25 md:-top-45 sm:-top-35 px-4 md:min-h-[70vh]">
