export default function WebSidebar({ isOpen, setIsOpen }) {
  const menuItems = [
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 z-50 h-[100vh] w-full bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-auto ${
          isOpen
            ? "translate-x-0"
            : "-translate-x-full overflow-y-auto hide-scrollbar"
        }`}>
            ...
            <div
              ...
              <div
                ...
                <div className="flex gap-1 justify-start items-start">
                  <img className="font-semibold" src={item.icon} alt="people" />
