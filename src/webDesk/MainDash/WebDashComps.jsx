...
const CategoriesGrid = () => {
  const categories = [
    {
      name: "Healthcare",
      count: "24 Product available",
      color: "bg-blue-100",
      icon: "🏥",
    },
    {
      name: "Electronics",
      count: "165 Product available",
      color: "bg-green-100",
      icon: "📱",
    },
    {
    ...
    {
      name: "Gadgets",
      count: "89 Product available",
      color: "bg-purple-100",
      icon: "🎮",
    },
    {
      name: "Devices",
      count: "116 Product available",
      color: "bg-gray-100",
      icon: "⚙️",
    },
  ];
    ...
    <div className="mb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {categories.map((category, index) => (
          <div
            key={index}
            className={`border border-[#e7e7e7] rounded-[15px] p-4 hover:shadow-md transition-shadow cursor-pointer`}>
    ...
    <div className="bg-[url('/resources/images/Banner.svg')] p-6 mb-6 text-white relative overflow-hidden w-full">
      <div className="relative">
        ...
        <p className="text-blue-100 mb-4 max-w-md">
          Streamline your workflow, deliver winning proposals that leave a
          impression.
        </p>
          ...
          <div
            ...
            <div className="flex items-center space-x-3">
              <div className="flex items-center space-x-3 p-2 bg-[#f3f3f3] rounded-btn border border-[#e5e5e5]">
                <img
                  src="/resources/icons/meetingActive.svg"
                  alt="meetingActive.svg"
                />
              </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex -space-x-1">
                    {[...Array(3)].map((_, i) => (
                      <div
                        key={i}
                        className="w-5 h-5 bg-gray-300 rounded-full border border-white"></div>
                    ))}
                    <span className="text-xs text-gray-500 ml-2">
                      +{meeting.avatars} more
                    </span>
                  </div>
                </div>
...
const RecentProposals = () => {
  const proposals = [
    {
      title: "Pile Driving Machine | Request of Proposal",
      date: "20 Dec, 2024 | 12:00 PM - 3:30 PM",
      type: "Construction",
    },
    {
      title: "Pile Driving Machine | Request of Proposal",
...
const ProjectProgress = () => {
  const projects = [
    {
      name: "Project Safelteet",
      date: "20 Dec, 2024 | 12:00 PM - 3:30 PM",
      progress: 70,
      status: "Active",
    },
    {
      name: "Project EcoVision",
      date: "18 Dec, 2024 | 8:00 AM - 11:30 AM",
      progress: 50,
      status: "In Progress",
    },
    {
      name: "Project Skyward",
      date: "21 Dec, 2024 | 2:00 PM - 5:30 PM",
      progress: 30,
      status: "Paused",
    },
    {
      name: "Project QuantumLeap",
      date: "19 Dec, 2024 | 10:00 AM - 1:30 PM",
      progress: 80,
      status: "Active",
    },
    {
      name: "Project Greenlands",
      date: "22 Dec, 2024 | 9:00 AM - 12:30 PM",
      progress: 40,
      status: "Pending",
    },
  ];
          ...
          <div key={index} className="space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-3 p-2 bg-[#f3f3f3] rounded-btn border border-[#e5e5e5]">
                  <img
                    src="/resources/icons/documentActive.svg"
                    alt="documentActive.svg"
                  />
                </div>
                <div>
              ...
              <div className="flex items-center space-x-2">
                <span
                  className={`px-2 py-1 text-xs rounded btn-pri ${getStatusColor(
                    project.status
                  )}`}>
                  {project.status}
                </span>
...
const RecentTransactions = () => {
  const transactions = [
    {
      name: "Desktop Table Project",
      date: "June 10, 2024 - 11:00 AM",
      amount: "99 SAR",
      type: "paid",
    },
    {
...
const VendorCards = () => {
  const vendors = [
    {
      name: "Al-Karim Co Ltd",
      des: "Technolab Solutions",
      rating: 4.5,
      id: "BMT120976",
      certified: true,
      type: "Construction",
        ...
        {vendors.map((vendor, index) => (
          <div
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div>
                <span className="btn-pri text-xs px-2 py-1 mx-1 rounded">
                  Active
                </span>
                <span className="btn-pri text-xs px-2 py-1 rounded">
                  Active
                </span>
                <h4 className="font-medium text-gray-900 mb-1">
                  {vendor.name}
                </h4>
                <h4 className="font-medium text-gray-500 mb-1 text-xs">
                  {vendor.des}
                </h4>
              </div>
              <div>
...
const ServicesGrid = () => {
  const services = [
    {
      name: "Fineone FE-0034 Gold Cardio Pro Stethoscope",
      price: "150 SAR",
  ...
  const ServiceCard = ({ service, isVehicle = false }) => (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      <div
        className={`h-32 flex items-center justify-center mx-2 mt-7 relative`}>
        <img
        ...
        />
        <div
          className={`text-xs px-2 py-1 rounded btn-pri flex gap-1 absolute left-2 -top-4 border-2 border-white`}>
          <img
            className="font-semibold"
      ...
      <div className="p-3">
        <p className="text-xs text-gray-500 bg-[#f7f7f7] px-3 py-1 rounded-btn border border-[#e5e5e5] mt-4 w-fit">
          Product
        </p>
        <h4 className="font-medium text-gray-900 text-sm my-2 line-clamp-2">
          {service.name}
        </h4>
        <div className="flex items-center justify-between">
...
export default function WebDashCopms() {
  return (
    <>
